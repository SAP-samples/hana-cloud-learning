...
--7. Create a function for column zipcode (STEP 7: Create a hierarchy function that shortens numbers from right to left)
...
--11. Create a function for grouping values to ranges (STEP 8: Create a hierarchy function that groups values to ranges)
